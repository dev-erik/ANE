...
echo ""
echo "  # MLX backend (~503 t/s decode, requires: pip3 install mlx-lm)"
echo "  $BINARY --mlx --http 8080"
echo "  curl http://localhost:8080/v1/completions -d '{\"model\":\"mlx-community/Qwen2.5-0.5B-Instruct-4bit\",\"prompt\":\"Hi\",\"max_tokens\":20}'"
echo ""
